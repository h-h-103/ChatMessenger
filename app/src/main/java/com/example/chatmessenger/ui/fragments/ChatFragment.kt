...
class ChatFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.sendBtn.setOnClickListener {
            ...
            if (messageText.isNotEmpty()) {
                viewModel.sendMessage(
                    ...
                    navArgs.user.userId,
                    messageText,
                    navArgs.user.userName,
                    navArgs.user.imgPath
                )
        ...
        setupRvMessages()
        viewModel.getMessages(firebaseAuth.currentUser!!.uid, navArgs.user.userId)
        observeGetMessages()
    ...
    private fun setInfo() {
        binding.apply {
            chatUserName.text = navArgs.user.userName
            chatUserStatus.text = navArgs.user.status
            Glide.with(requireView()).load(navArgs.user.imgPath).into(chatImageViewUser)
        }
    }
